function header() {
  return (
    <header>
      <div class="container">
        <a href="#" class="logo">
          <img src="./Images/trivago-logo.png" alt="Trivago logo"></img>
        </a>
        <div>
          <nav id="navOne">
            <ul>
  ...
  return (
    <footer>
      ...
      <div id="f4">
        ...
        <ul>
          <li>
            <a>Mobile apps - searching on the go</a>
          </li>
          <li>
            <a>trivago Business Studio</a>
          </li>
        </ul>
        <ul>
          <li>
          ...
          <li>
            <a>Coronavirus (COVID-19) travel advice</a>
          </li>
        </ul>
      </div>
      <div id="f5">
